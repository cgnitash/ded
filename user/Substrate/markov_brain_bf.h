...
class markov_brain_bf
{

  std::string front_in_sense_ = "<double,inputs>";
  std::string back_in_sense_  = "<double,inputs>";
...
public:
      ...
      publishConfiguration()
  {
    ...
    es.bindInput("front_in_sense", "<double,inputs>");
    es.bindInput("back_in_sense", "<double,inputs>");
      ...
      configure(ded::specs::SubstrateSpec es)
  {
    ...
    es.configureInput("front_in_sense", front_in_sense_);
    es.configureInput("back_in_sense", back_in_sense_);
