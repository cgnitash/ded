...
ded::concepts::Encoding
    markov_brain_irregular_cppn::parseEncoding(std::string s)
{
...
void
    markov_brain_irregular_cppn::reset()
{
  for (auto &b : buffer_)
    b = 0;
}
...
void
    markov_brain_irregular_cppn::mutate()
{
...
void
    markov_brain_irregular_cppn::input(std::string n, ded::concepts::Signal s)
{
  if (n == in_sense_)
  {
...
ded::concepts::Signal
    markov_brain_irregular_cppn::output(std::string n)
{
...
void
    markov_brain_irregular_cppn::tick()
{
...
void
    markov_brain_irregular_cppn::compute_gates_()
{
